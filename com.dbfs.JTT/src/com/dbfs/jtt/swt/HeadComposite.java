...
public class HeadComposite extends Composite {
	...
	private final Combo comboStatusFilter;
	...
	public HeadComposite(Composite parent, int style) {
		...
		/***
		 * temporary hiding Combo comboFilterTasks = new Combo(this, SWT.READ_ONLY | SWT.NO_FOCUS); FormData fd_combo = new FormData(); fd_combo.left = new FormAttachment(0, 10); fd_combo.bottom = new FormAttachment(100, -270); comboFilterTasks.setLayoutData(fd_combo); comboFilterTasks.add("Sorting by"); comboFilterTasks.add("Number"); comboFilterTasks.add("Priority"); comboFilterTasks.select(0);
		 ***/
		...
		/*** temporary ***/
		fd_comboFilterPrj.right = new FormAttachment(0, 100);
