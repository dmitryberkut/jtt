...
public class DailyTotalCounter {
	...
	private final Logger logger = Logger.getLogger(DailyTotalCounter.class);
	...
	private Long load() {
		...
		Long res = 0l;
		// get presets
		ISecurePreferences preferences = getActualPresets(userName);
	...
	/**
	 * Return actual presets node with binding to user and date. If saved day is not today - remove all not actual.
	 * 
	 * @return
	 */
